...
const AdminProviders = () => {
  ...
  //posting
  const [providersDetail, setprovidersDetail] = useState<null | any>(null);
  ...
  const pageConfig = new PageConfig(
    `${status == "Approved" ? "View" : "Review"} Provider`,
    "",
    "",
    "Provider",
    `providers/review-update/${eId}`,
    [Assist.ROLE_ADMIN],
  );
  ...
  useEffect(() => {
    ...
    if (pageConfig.Id != 0) {
      setLoading(true);
      setTimeout(() => {
        Assist.loadData(pageConfig.Title, `providers/id/${pageConfig.Id}`)
          .then((data) => {
            setLoading(false);
            updateVaues(data);
            setError(false);
  ...
  const updateVaues = (res: any) => {
    setprovidersDetail(res.providers);
    // approval
    setStatus(res.providers.status.status_name);
    setStage(res.providers.stage.stage_name);
    setStageId(res.providers.stage_id);
    setApprovalLevels(res.providers.approval_levels);

    setCreatedBy(res.providers.user.email);
  };
  ...
  const unsubmitPosting = () => {
    ...
    const postData = { ...providersDetail, ...newData };

    setTimeout(() => {
      Assist.postPutData(
        pageConfig.Title,
        `providers/update/${eId}`,
        postData,
        1,
      )
        .then((data) => {
        ...
        <Col sz={12} sm={12} lg={7}>
         <Card title="Properties" showHeader={true}>
          ...
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{providersDetail.user.email}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{providersDetail.user.fname} {providersDetail.user.lname}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>{providersDetail.status.status_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Approval Levels</div>
            <div className="dx-field-value-static">
              <strong>{providersDetail.approval_levels}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Stage</div>
            <div className="dx-field-value-static">
              <strong>{providersDetail.stage.stage_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Date</div>
            <div className="dx-field-value-static">
              <strong>{Assist.getDateText(providersDetail.created_at)}</strong>
            </div>
          </div>
          {unsubmitButton()}
        </div>
              ...
              <div className="form">
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>
                        {Assist.getDateText(providersDetail.review1_at)}
                      </strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{providersDetail.review1_by}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Comments</div>
                    <div className="dx-field-value-static">
                      <strong>{providersDetail.review1_comments}</strong>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(providersDetail.review2_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{providersDetail.review2_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{providersDetail.review2_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(providersDetail.review3_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{providersDetail.review3_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{providersDetail.review3_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
