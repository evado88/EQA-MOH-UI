...
const AdminLabTypeList = () => {
  ...
  const addButtonOptions = useMemo(
    () => ({
      icon: "add",
      text: "New Lab Type",
      onClick: () => navigate("/admin/lab-types/add"),
    }),
    [],
  );
              ...
              <Column
                ...
                cellRender={(e) => {
                  if (e.data.status.status_name == "Draft") {
                    return (
                    <Link to={`/admin/lab-types/edit/${e.data.id}`}>
                      {e.text}
                    </Link>
                  );
                  } else {
                    return (
                    <Link to={`/admin/lab-types/view/${e.data.id}`}>
                      {e.text}
                    </Link>
                  );
                  }
...
export default AdminLabTypeList;