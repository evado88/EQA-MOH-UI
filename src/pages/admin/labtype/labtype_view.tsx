...
const AdminLabType = () => {
  ...
  //posting
  const [labtypeDetail, setlabtypeDetail] = useState<null | any>(null);
  ...
  const pageConfig = new PageConfig(
    `${status == "Approved" ? "View" : "Review"} Lab Type`,
    "",
    "",
    "Lab Type",
    `lab-types/review-update/${eId}`,
    [Assist.ROLE_ADMIN],
  );
  ...
  useEffect(() => {
    ...
    if (pageConfig.Id != 0) {
      setLoading(true);
      setTimeout(() => {
        Assist.loadData(pageConfig.Title, `lab-types/id/${pageConfig.Id}`)
          .then((data) => {
            setLoading(false);
            updateVaues(data);
            setError(false);
  ...
  const updateVaues = (res: any) => {
    setlabtypeDetail(res.labtype);
    // approval
    setStatus(res.labtype.status.status_name);
    setStage(res.labtype.stage.stage_name);
    setStageId(res.labtype.stage_id);
    setApprovalLevels(res.labtype.approval_levels);

    setCreatedBy(res.labtype.user.email);
  };
  ...
  const unsubmitPosting = () => {
    ...
    const postData = { ...labtypeDetail, ...newData };

    setTimeout(() => {
      Assist.postPutData(
        pageConfig.Title,
        `lab-types/update/${eId}`,
        postData,
        1,
      )
        .then((data) => {
        ...
        <Col sz={12} sm={12} lg={7}>
         <Card title="Properties" showHeader={true}>
          ...
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{labtypeDetail.user.email}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{labtypeDetail.user.fname} {labtypeDetail.user.lname}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>{labtypeDetail.status.status_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Approval Levels</div>
            <div className="dx-field-value-static">
              <strong>{labtypeDetail.approval_levels}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Stage</div>
            <div className="dx-field-value-static">
              <strong>{labtypeDetail.stage.stage_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Date</div>
            <div className="dx-field-value-static">
              <strong>{Assist.getDateText(labtypeDetail.created_at)}</strong>
            </div>
          </div>
          {unsubmitButton()}
        </div>
              ...
              <div className="form">
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>
                        {Assist.getDateText(labtypeDetail.review1_at)}
                      </strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{labtypeDetail.review1_by}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Comments</div>
                    <div className="dx-field-value-static">
                      <strong>{labtypeDetail.review1_comments}</strong>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(labtypeDetail.review2_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{labtypeDetail.review2_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{labtypeDetail.review2_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(labtypeDetail.review3_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{labtypeDetail.review3_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{labtypeDetail.review3_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
