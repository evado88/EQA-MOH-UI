...
const AdminMethodList = () => {
  ...
  const addButtonOptions = useMemo(
    () => ({
      icon: "add",
      text: "New Method",
      onClick: () => navigate("/admin/methods/add"),
    }),
    [],
  );
              ...
              <Column
                ...
                cellRender={(e) => {
                  if (e.data.status.status_name == "Draft") {
                    return (
                    <Link to={`/admin/methods/edit/${e.data.id}`}>
                      {e.text}
                    </Link>
                  );
                  } else {
                    return (
                    <Link to={`/admin/methods/view/${e.data.id}`}>
                      {e.text}
                    </Link>
                  );
                  }
...
export default AdminMethodList;