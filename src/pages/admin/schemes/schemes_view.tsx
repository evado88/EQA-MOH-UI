...
const AdminSchemes = () => {
  ...
  //posting
  const [schemesDetail, setschemesDetail] = useState<null | any>(null);
  ...
  const pageConfig = new PageConfig(
    `${status == "Approved" ? "View" : "Review"} Scheme`,
    "",
    "",
    "Scheme",
    `schemes/review-update/${eId}`,
    [Assist.ROLE_ADMIN],
  );
  ...
  useEffect(() => {
    ...
    if (pageConfig.Id != 0) {
      setLoading(true);
      setTimeout(() => {
        Assist.loadData(pageConfig.Title, `schemes/id/${pageConfig.Id}`)
          .then((data) => {
            setLoading(false);
            updateVaues(data);
            setError(false);
  ...
  const updateVaues = (res: any) => {
    setschemesDetail(res.schemes);
    // approval
    setStatus(res.schemes.status.status_name);
    setStage(res.schemes.stage.stage_name);
    setStageId(res.schemes.stage_id);
    setApprovalLevels(res.schemes.approval_levels);

    setCreatedBy(res.schemes.user.email);
  };
  ...
  const unsubmitPosting = () => {
    ...
    const postData = { ...schemesDetail, ...newData };
        ...
        <Col sz={12} sm={12} lg={7}>
         <Card title="Properties" showHeader={true}>
          ...
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{schemesDetail.user.email}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{schemesDetail.user.fname} {schemesDetail.user.lname}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>{schemesDetail.status.status_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Approval Levels</div>
            <div className="dx-field-value-static">
              <strong>{schemesDetail.approval_levels}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Stage</div>
            <div className="dx-field-value-static">
              <strong>{schemesDetail.stage.stage_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Date</div>
            <div className="dx-field-value-static">
              <strong>{Assist.getDateText(schemesDetail.created_at)}</strong>
            </div>
          </div>
          {unsubmitButton()}
        </div>
              ...
              <div className="form">
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>
                        {Assist.getDateText(schemesDetail.review1_at)}
                      </strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{schemesDetail.review1_by}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Comments</div>
                    <div className="dx-field-value-static">
                      <strong>{schemesDetail.review1_comments}</strong>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(schemesDetail.review2_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{schemesDetail.review2_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{schemesDetail.review2_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(schemesDetail.review3_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{schemesDetail.review3_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{schemesDetail.review3_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
