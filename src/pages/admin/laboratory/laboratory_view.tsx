...
const AdminLaboratory = () => {
  ...
  //posting
  const [laboratoryDetail, setlaboratoryDetail] = useState<null | any>(null);
  ...
  const pageConfig = new PageConfig(
    `${status == "Approved" ? "View" : "Review"} Laboratory`,
    "",
    "",
    "Laboratory",
    `laboratorys/review-update/${eId}`,
    [Assist.ROLE_ADMIN],
  );
  ...
  const updateVaues = (res: any) => {
    setlaboratoryDetail(res.laboratory);
    // approval
    setStatus(res.laboratory.status.status_name);
    setStage(res.laboratory.stage.stage_name);
    setStageId(res.laboratory.stage_id);
    setApprovalLevels(res.laboratory.approval_levels);

    //a lab that registered itself has no owning user until it is approved
    setCreatedBy(res.laboratory.user?.email ?? res.laboratory.created_by);
  };
  ...
  const unsubmitPosting = () => {
    ...
    const postData = { ...laboratoryDetail, ...newData };

    setTimeout(() => {
      Assist.postPutData(
        pageConfig.Title,
        `laboratorys/update/${eId}`,
        postData,
        1,
      )
        .then((data) => {
                ...
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.name}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Description</div>
                    <div className="dx-field-value-static">
                      {laboratoryDetail.description}
                    </div>
                  </div>
                </div>
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.code}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Type of Lab</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.labtype.name}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Province</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.province.name}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">District</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.district.name}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Physical Address</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.physical_address}</strong>
                    </div>
                  </div>
                </div>
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.contact_person_name}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Position</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.position}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Phone Number</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.phone_number}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Email Address</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.email_address}</strong>
                    </div>
                  </div>
                </div>
                <div className="dx-fieldset">
                  <div className="dx-fieldset-header">Scheme Selection</div>
                  <div className="dx-field">
                    <div className="dx-field-label">Name</div>
                    <div className="dx-field-value-static">
                      <DataGrid
                        className={"dx-card wide-card"}
                        dataSource={laboratoryDetail.method_list}
                        keyExpr={"id"}
                        showBorders={false}
                ...
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>
                        <strong>
                          {laboratoryDetail.user?.email ??
                            laboratoryDetail.created_by}
                        </strong>
                      </strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>
                        <strong>
                          {laboratoryDetail.user
                            ? `${laboratoryDetail.user.fname} ${laboratoryDetail.user.lname}`
                            : "Self registered"}
                        </strong>
                      </strong>
                    </div>
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.status.status_name}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Approval Levels</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.approval_levels}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Stage</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.stage.stage_name}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>
                        {Assist.getDateText(laboratoryDetail.created_at)}
                      </strong>
                    </div>
                  </div>
                  {unsubmitButton()}
              ...
              <div className="form">
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>
                        {Assist.getDateText(laboratoryDetail.review1_at)}
                      </strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.review1_by}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Comments</div>
                    <div className="dx-field-value-static">
                      <strong>{laboratoryDetail.review1_comments}</strong>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(laboratoryDetail.review2_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{laboratoryDetail.review2_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{laboratoryDetail.review2_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(laboratoryDetail.review3_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{laboratoryDetail.review3_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{laboratoryDetail.review3_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
