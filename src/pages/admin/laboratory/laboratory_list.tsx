...
const AdminLaboratoryList = () => {
  ...
  const addButtonOptions = useMemo(
    () => ({
      icon: "add",
      text: "New Laboratory",
      onClick: () => navigate("/admin/laboratorys/add"),
    }),
    [],
  );
        ...
        <Col sz={12} sm={12} lg={12}>
          <Card showHeader={false}>
            ...
            >
              ...
              <Column dataField="id" caption="ID" hidingPriority={15}></Column>
              <Column
                dataField="name"
                caption="Name"
                hidingPriority={14}
                ...
                cellRender={(e) => {
                  if (e.data.status.status_name == "Draft") {
                    return (
                    <Link to={`/admin/laboratorys/edit/${e.data.id}`}>
                      {e.text}
                    </Link>
                  );
                  } else {
...
export default AdminLaboratoryList;