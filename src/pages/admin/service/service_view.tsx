...
const AdminService = () => {
  ...
  //posting
  const [serviceDetail, setserviceDetail] = useState<null | any>(null);
  ...
  const pageConfig = new PageConfig(
    `${status == "Approved" ? "View" : "Review"} Service`,
    "",
    "",
    "Service",
    `services/review-update/${eId}`,
    [Assist.ROLE_ADMIN],
  );
  ...
  useEffect(() => {
    ...
    if (pageConfig.Id != 0) {
      setLoading(true);
      setTimeout(() => {
        Assist.loadData(pageConfig.Title, `services/id/${pageConfig.Id}`)
          .then((data) => {
            setLoading(false);
            updateVaues(data);
            setError(false);
  ...
  const updateVaues = (res: any) => {
    ...
    // approval
    setStatus(res.service.status.status_name);
    setStage(res.service.stage.stage_name);
    setStageId(res.service.stage_id);
    setApprovalLevels(res.service.approval_levels);

    setCreatedBy(res.service.user.email);
  };
  ...
  const unsubmitPosting = () => {
    ...
    const postData = { ...serviceDetail, ...newData };
      ...
      <Row>
        <Col sz={12} sm={12} lg={7}>
         <Card title="Properties" showHeader={true}>
          {serviceDetail != null && <div className="form">
          <div className="dx-fieldset">
            <div className="dx-fieldset-header">Details</div>
            <div className="dx-field">
              <div className="dx-field-label">Name</div>
              <div className="dx-field-value-static">
                <strong>{serviceDetail.name}</strong>
              </div>
            </div>
            <div className="dx-field">
          ...
          <div className="dx-fieldset-header">Scheme</div>
            <div className="dx-field">
             ...
             <div className="dx-field-value-static">
               <strong>{serviceDetail.scheme.name}</strong>
            </div>
            </div> 
          </div>
          <div className="dx-fieldset">
          ...
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{serviceDetail.user.email}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{serviceDetail.user.fname} {serviceDetail.user.lname}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>{serviceDetail.status.status_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Approval Levels</div>
            <div className="dx-field-value-static">
              <strong>{serviceDetail.approval_levels}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Stage</div>
            <div className="dx-field-value-static">
              <strong>{serviceDetail.stage.stage_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Date</div>
            <div className="dx-field-value-static">
              <strong>{Assist.getDateText(serviceDetail.created_at)}</strong>
            </div>
          </div>
          {unsubmitButton()}
        </div>
              ...
              <div className="form">
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>
                        {Assist.getDateText(serviceDetail.review1_at)}
                      </strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{serviceDetail.review1_by}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Comments</div>
                    <div className="dx-field-value-static">
                      <strong>{serviceDetail.review1_comments}</strong>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(serviceDetail.review2_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{serviceDetail.review2_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{serviceDetail.review2_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(serviceDetail.review3_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{serviceDetail.review3_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{serviceDetail.review3_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
