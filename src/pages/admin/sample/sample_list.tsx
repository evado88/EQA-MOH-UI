...
const AdminSampleList = () => {
  ...
  const addButtonOptions = useMemo(
    () => ({
      icon: "add",
      text: "New Sample",
      onClick: () => navigate("/admin/samples/add"),
    }),
    [],
  );
              ...
              <Column
                ...
                cellRender={(e) => {
                  if (e.data.status.status_name == "Draft") {
                    return (
                    <Link to={`/admin/samples/edit/${e.data.id}`}>
                      {e.text}
                    </Link>
                  );
                  } else {
                    return (
                    <Link to={`/admin/samples/view/${e.data.id}`}>
                      {e.text}
                    </Link>
                  );
                  }
...
export default AdminSampleList;