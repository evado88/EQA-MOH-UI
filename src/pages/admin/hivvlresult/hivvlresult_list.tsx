...
const AdminHIVVLResultList = () => {
  ...
  const cyclesUrl = `hiv-vl-results/cycles`;
  const resultsUrl = (id: number) =>
    `hiv-vl-results/list?pt_cycle_id=${id}`;
                ...
                cellRender={(e) => {
                  const target =
                    e.data.status.status_name == "Draft"
                      ? `/admin/hiv-vl-results/edit/${e.data.id}`
                      : `/admin/hiv-vl-results/view/${e.data.id}`;
...
export default AdminHIVVLResultList;
