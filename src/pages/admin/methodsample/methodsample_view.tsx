...
const AdminMethodSample = () => {
  ...
  //posting
  const [methodsampleDetail, setmethodsampleDetail] = useState<null | any>(null);
  ...
  const pageConfig = new PageConfig(
    `${status == "Approved" ? "View" : "Review"} Method Sample`,
    "",
    "",
    "Method Sample",
    `method-samples/review-update/${eId}`,
    [Assist.ROLE_ADMIN],
  );
  ...
  useEffect(() => {
    ...
    if (pageConfig.Id != 0) {
      setLoading(true);
      setTimeout(() => {
        Assist.loadData(pageConfig.Title, `method-samples/id/${pageConfig.Id}`)
          .then((data) => {
            setLoading(false);
            updateVaues(data);
            setError(false);
  ...
  const updateVaues = (res: any) => {
    setmethodsampleDetail(res.methodsample);
    // approval
    setStatus(res.methodsample.status.status_name);
    setStage(res.methodsample.stage.stage_name);
    setStageId(res.methodsample.stage_id);
    setApprovalLevels(res.methodsample.approval_levels);

    setCreatedBy(res.methodsample.user.email);
  };
  ...
  const unsubmitPosting = () => {
    ...
    const postData = { ...methodsampleDetail, ...newData };

    setTimeout(() => {
      Assist.postPutData(
        pageConfig.Title,
        `method-samples/update/${eId}`,
        postData,
        1,
      )
        .then((data) => {
      ...
      <Row>
        <Col sz={12} sm={12} lg={7}>
         <Card title="Properties" showHeader={true}>
          {methodsampleDetail != null && <div className="form">
          <div className="dx-fieldset">
            <div className="dx-fieldset-header">Details</div>
            <div className="dx-field">
              <div className="dx-field-label">Name</div>
              <div className="dx-field-value-static">
                <strong>{methodsampleDetail.name}</strong>
              </div>
            </div>
            <div className="dx-field">
              <div className="dx-field-label">Description</div>
              <div className="dx-field-value-static">
           {methodsampleDetail.description}
              </div>
            </div>
          </div>
          <div className="dx-fieldset">
          <div className="dx-fieldset-header">Scheme</div>
            <div className="dx-field">
             ...
             <div className="dx-field-value-static">
               <strong>{methodsampleDetail.scheme.name}</strong>
            </div>
            </div>
            <div className="dx-field">
              <div className="dx-field-label">Service</div>
             <div className="dx-field-value-static">
               <strong>{methodsampleDetail.service.name}</strong>
            </div>
            </div>
            <div className="dx-field">
              <div className="dx-field-label">Method</div>
             <div className="dx-field-value-static">
               <strong>{methodsampleDetail.method.name}</strong>
            </div>
            </div> 
          </div>
          <div className="dx-fieldset">
          ...
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{methodsampleDetail.user.email}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>
              <strong>{methodsampleDetail.user.fname} {methodsampleDetail.user.lname}</strong>
              </strong>
            </div>
          </div>
          <div className="dx-field">
            ...
            <div className="dx-field-value-static">
              <strong>{methodsampleDetail.status.status_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Approval Levels</div>
            <div className="dx-field-value-static">
              <strong>{methodsampleDetail.approval_levels}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Stage</div>
            <div className="dx-field-value-static">
              <strong>{methodsampleDetail.stage.stage_name}</strong>
            </div>
          </div>
          <div className="dx-field">
            <div className="dx-field-label">Date</div>
            <div className="dx-field-value-static">
              <strong>{Assist.getDateText(methodsampleDetail.created_at)}</strong>
            </div>
          </div>
          {unsubmitButton()}
        </div>
              ...
              <div className="form">
                <div className="dx-fieldset">
                  ...
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>
                        {Assist.getDateText(methodsampleDetail.review1_at)}
                      </strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    ...
                    <div className="dx-field-value-static">
                      <strong>{methodsampleDetail.review1_by}</strong>
                    </div>
                  </div>
                  <div className="dx-field">
                    <div className="dx-field-label">Comments</div>
                    <div className="dx-field-value-static">
                      <strong>{methodsampleDetail.review1_comments}</strong>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(methodsampleDetail.review2_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{methodsampleDetail.review2_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{methodsampleDetail.review2_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
                  ...
                  <div className="dx-fieldset">
                    ...
                    <div className="dx-field">
                      ...
                      <div className="dx-field-value-static">
                        {" "}
                        <strong>
                          {Assist.getDateText(methodsampleDetail.review3_at)}
                        </strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Reviewer</div>
                      <div className="dx-field-value-static">
                        <strong>{methodsampleDetail.review3_by}</strong>
                      </div>
                    </div>
                    <div className="dx-field">
                      <div className="dx-field-label">Comments</div>
                      <div className="dx-field-value-static">
                        <strong>{methodsampleDetail.review3_comments}</strong>
                      </div>
                    </div>
                  </div>
                )}
...
export default AdminMethodSample;